...
We compared the best model, length 1+height+ width, with a model which uses all the variables. While height plus width was initially identified as the best model, there is no statistically significant difference from the other models. This is determined with the high p-value (0.8762) of this ANOVA.  
